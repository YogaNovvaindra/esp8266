...
void loop() {
  ...
  WiFiClient client;
  if (client.connect("http://dehidrasi.yoganova.my.id/esp32.php", 80)) {
    client.println("POST /upload HTTP/1.1");
    client.println("Host: http://dehidrasi.yoganova.my.id/esp32.php");
  ...
  delay(5000); // Delay for 5 seconds before taking the next photo
}
